...
class ctcTabWidget {
	...
	function run (
		...
		$out->addWikiTextAsContent( $ctcDoc, true, $out->getTitle() );
	 ...
	 */
	private static function buildTabHeaders ( string $ctcTabName1, string $ctcTabName2, string $ctcTabName3, string $ctcTopRight ): string {
		$ctcTabHeaders = <<<EOT
